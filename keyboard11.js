 ...
 */
 ...
 document.write("<script src='jquery-1.7.1.min.js'></script>");
var VKI_attach, VKI_close;
(function() {
  var self = this;
  this.VKI_moveAdj=true;
  this.ktop=0;
  this.kleft=0;
  ...
  this.VKI_kts = this.VKI_kt ='\u09ac\u09be\u0982\u09b2\u09be';//"Bengali"; //"US International";  // Default keyboard layout 'US Standard'
  ...
  VKI_attach = function(elem) {
    ...
    if (self.VKI_imageURI) {
      var keybut = document.createElement('img');
	     nep=document.getElementById("CONTROLSeditor_0");
		 childp=document.getElementById("formatblockeditor_0");
	      keybut.id="kimg";
		  ...
		  nep.insertBefore(keybut, childp); 
		//nep.appendChild(keybut);
		 // insertAfter(keybut, elem);
		  
     //elem.parentNode.insertBefore(keybut, (elem.dir == "rtl") ? elem : elem.nextSibling );//insertBefore elem.nextSibling
    } else {
      ...
      var th = document.createElement('th');
		...
		////////////////
			...
			if (this.VKI_moveAdj){
				var otop=0;
			var oleft=0;
			 var moved = document.createElement("moved");
           moved.appendChild(document.createTextNode("\u2207"));
            moved.title = this.VKI_i18n['12'];
		    moved.id="move";
			
         VKI_addListener( moved, 'click', function(e) {
		 otop=e.clientX;
		 oleft=e.clienty;
         ...
         // self.VKI_kbsize();  
		  ...
		  var moveu = document.createElement("moveu");
           moveu.appendChild(document.createTextNode("\u2206"));
            moveu.title = this.VKI_i18n['12'];
		    moveu.id="move"; 
		  
		  
		  VKI_addListener( moveu, 'click', function(e) {
		 otop=e.clientX;
		 oleft=e.clienty;
         ...
         // self.VKI_kbsize();  
           ...
           mover.appendChild(document.createTextNode("\u22b2"));
            mover.title = this.VKI_i18n['12'];
		    mover.id="move"; 
		  
		  
		  VKI_addListener( mover, 'click', function(e) {
		 otop=e.clientX;
		 oleft=e.clienty;
		 ...
		 var movel = document.createElement("movel");
           movel.appendChild(document.createTextNode("\u22b3"));
            movel.title = this.VKI_i18n['12'];
		    movel.id="move"; 
		  
		  
		  VKI_addListener( movel, 'click', function(e) {
		 otop=e.clientX;
		 oleft=e.clienty;
         ...
         // self.VKI_kbsize();  
		  ...
		  VKI_mouseEvents( movel);
		  th.appendChild(movel);
		  
		  VKI_mouseEvents( moved);
		  th.appendChild(moved);
		  
		  VKI_mouseEvents( moveu);
		  th.appendChild(moveu);
		 
		  
          VKI_mouseEvents( mover);
		  th.appendChild(mover);
...
///////////////////////////////////////////////////
    ...
    if (typeof this.VKI_target.maxlength == "undefined" ||
      ...
      if (this.VKI_target.setSelectionRange && !this.VKI_target.readOnly && !this.VKI_isIE) {
        ...
        this.VKI_target.range.select();
	          ...
	          this.VKI_target.innerHTML=this.VKI_target.innerHTML+text;
	  }
  ...
  this.VKI_show = function(elem) {
    if (!this.VKI_target) {
      ...
      this.VKI_target.keyboardPosition = "relative";//"absolute";
      do {
  ...
  this.VKI_position = function(force) {
    if (self.VKI_target) {
      ...
      if (place || force === true) {
        ...
        self.VKI_keyboard.style.top = iPos[1] - ((self.VKI_target.keyboardPosition =="relative"  && !self.VKI_isIE && !self.VKI_isMoz) ? sDis[1] : 0) + fudge +this.ktop +"px";
        self.VKI_keyboard.style.left = Math.max(10, Math.min(wDim[0] - self.VKI_keyboard.offsetWidth -25, iPos[0])) + self.kleft +"px";
        if (self.VKI_isIE6) {
          self.VKI_iframe.style.width = self.VKI_keyboard.offsetWidth + "px";
          self.VKI_iframe.style.height = self.VKI_keyboard.offsetHeight + "px";
          self.VKI_iframe.style.top = self.VKI_keyboard.style.top+100;
